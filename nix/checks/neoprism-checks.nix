...
rustPlatform.buildRustPackage {
  ...
  checkPhase = ''
    ...
    cargo clippy -p identus-did-prism-indexer --all-targets --features in-memory -- -D warnings
    ...
    cargo clippy -p identus-did-prism-submitter --all-targets --features in-memory -- -D warnings
  '';
