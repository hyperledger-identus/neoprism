...
- **Backups**: use filesystem snapshots or `sqlite3 neoprism.db ".backup backup.db"`; copying the database file while the node is stopped is usually sufficient for local setups.
